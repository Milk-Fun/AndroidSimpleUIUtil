 ...
 * <p>
 * 可移动按钮，为了解决第一款按钮无法设置背景，
 * 这个可以设置按钮漂浮属性来设置浮动
 */
public class ZMoveButton extends AppCompatImageView {
    ...
    public ZMoveButton(Context context) {
        this(context, null);
    }

    public ZMoveButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZMoveButton(Context context, AttributeSet attrs, int defStyleAttr) {
