...
/**
 * Create by zuoqi@bhz.com.cn on 2019/11/8 13:46
 * <p>
 * 摘自作者 @author ljm 的博客，感谢这位作者
 * 后期我对其中的一些BUG进行了解决和优化
 * <p>
 * 侧滑菜单栏RecyclerView，模仿QQ聊天列表交互，
 * 即触碰已打开菜单栏以外的itemView时，关闭菜单栏并拦截丢弃该次触碰事件
 */
public class ZtxSlideRecyclerView extends RecyclerView {
    ...
    public ZtxSlideRecyclerView(Context context) {
        super(context);
        init();
    }

    public ZtxSlideRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ZtxSlideRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
